...
public class CommissionedState implements State 
{
    public ArrayList<Commissioned> commissioneds = new ArrayList<>();
            ...
            if(change_controll == 1)
            {
                ...
                for(index=0;index<commissioneds.size();index++)
                {
                    ...
                    if(commissioned_employee.getId() == id)
                    {
                        ...
                        commissioneds.remove(index);
                        commissioneds.add(index,commissioned_employee);
                    }
                }
                break;  
            }
    ...
    public void Add_service(int id)
    {
        ...
        {
            commissioned_employee = commissioneds.get(index);
            if(commissioned_employee.getId() == id && commissioned_employee.getIs_sindicate() == 1)
            {
