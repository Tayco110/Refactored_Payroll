...
public class HourlyState implements State 
{
    ...
    private int is_sindicate,sindicate_id,index,change_controll,tc_in_h,tc_in_m,tc_out_h,tc_out_m,finded = 0; 
    ...
    public void Add_service(int id)
    {
        ...
        {
            hourly_employee = hourlies.get(index);
            if(hourly_employee.getId() == id && hourly_employee.getIs_sindicate() == 1)
            {
